<?php
    ...
    $to = 'ariimartinez4@gmail.com'; //Aquí definimos quien recibirá el formulario
    $from = 'ariimartinez4@gmail.com'; //Aquí definimos que cuenta mandará el correo, generalmente perteneciente al mismo dominio
    $host = 'smtp.gmail.com'; //Aquí definimos cual es el servidor de correo saliente desde el que se enviaran los correos
    $port = '587';
    $username = 'ariimartinez4@gmail.com'; //Aqui se define el usuario de la cuenta de correo
    $password = '13566114Tst'; //Aquí se define la contraseña de la cuenta de correo que enviará el mensaje
